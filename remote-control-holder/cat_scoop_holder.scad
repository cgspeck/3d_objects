...
// smaller 34, larger 45
device_thickness = 45;
device_width = 108;
clearance_width = 2;
clearance_thickness = 1;
// Suggest you keep this to less then 50% of device's height
// smaller 100, larger 145
tray_height = 145;

front_cutout_width = device_width - 40;
front_lip_height = 10;

bottom_cutout_width = front_cutout_width;
...
// smaller 15, larger 25
screw_start = 25;
// smaller 25, larger 40
screw_centers = 40;
outer_radius = 5;
inner_radius = 0;
