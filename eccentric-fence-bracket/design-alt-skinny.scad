...
module ScrewHead(extra_head_through=0) {
    cylinder_outer(ref_thickness + 2 * de_minimis, screw_hole_rad);
    translate([0,0,-extra_head_through]) cylinder_outer(ref_thickness  / 2 + 1 * de_minimis + extra_head_through, screw_head_rad);
}
